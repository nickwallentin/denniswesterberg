  ...
  return (
    <Layout>
      ...
      <PageContainer>
            ...
            <Grid gridTemplateColumns={["1fr", "1fr 1fr"]} gridGap="5">
              ...
              >
                ...
                <CallToAction>
                  <a
                    className="main"
                    href="mailto:dennis@denniswesterberg.com?subject=Boka föreläsning&body=Hej Dennis, jag är intresserad av att boka en föreläsning. Kan du berätta lite mer om hur det fungerar och vad det kostar?"
                  >
                    Maila Dennis
                  </a>
        ...
        <Box>
          <Container>
            <Grid mb="5" gridTemplateColumns={["1fr", "1fr 1fr"]} gridGap="5">
              <Box>
                <Img
                  loading
          ...
          <Container maxWidth="800px !important" textAlign="center">
            <Flex flexDirection="column" alignItems="center">
              ...
              <Heading
                ...
                color="var(--c-accent)"
              >
                En föreläsning för dig som tar en välmående arbetsplats på
                allvar.
              </Heading>
              <CallToAction>
                <a
